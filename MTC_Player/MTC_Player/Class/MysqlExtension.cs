...
namespace Alta.Class
{
    ...
    public static class MysqlExtensions
    {
        ...
        public static List<Code.Schedule.Event> toSchedules(this MySqlDataReader reader)
        {
            if (reader.HasRows)
            {
                List<Code.Schedule.Event> events = new List<Code.Schedule.Event>();
                while (reader.Read())
                {
                    if (!reader.IsDBNull(0))
                    {
                        Code.Schedule.Event e = new Code.Schedule.Event();
        ...
        public static Code.Schedule.Event toSchedule(this MySqlDataReader reader)
        {
            if (reader.HasRows)
            {
                Code.Schedule.Event e = null;
                while (reader.Read())
                {
                    if (!reader.IsDBNull(0))
                    {
